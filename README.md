...
| `/loop-kit:flow` | 스킬을 엮는 오케스트레이션 (소스→검수→변환→검증→승인→싱크) | 플로우 정의 린터 : 빈 계약·6컬럼·사람 체크포인트·구두점 |

> 현재 `v0.11.0` : 스킬 11종. Tier 1 한국 실무 스킬 6종(proposal·email·weekly·blog·proofread·resume) + 오케스트레이션 스킬 flow.
